...
const Page: React.FC<ProductProps> = ({params}) => {
  ...
  return (
    ...
    <div className='flex gap-10 w-full min-h-[90dvh] mt-20 mb-20 px-10 m-auto'>
     <div className='flex-[.6] border-4 border-gray-600 gallery__main grid place-content-center w-full aspect-square text-white text-xl bg-rose-600'>Image</div>
     <div className='flex-[.4] border w-full py-5 flex flex-col gap-5 px-10'>
        <h1 className='text-[#27292a] leading-[1.2] uppercase tracking-[-.02em] text-[4rem] font-[900] heading'>{slug}</h1>
        <h2 className='text-cyan-600  font-[500] text-lg'>R 200</h2>
        <p className=' text-lg font-[500] leading-[1.5] flex flex-wrap'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor. ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod te </p>
      ...
      <div className="w-24 min-w-16 h-14 text-[1rem] leading-[1.5] border-2">
        <select className=" px-2 text-lg font-[500] w-full h-full cursor-pointer leading-[1.5] text-[#27292a]">
