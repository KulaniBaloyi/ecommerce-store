  ...
  return (
    <section className="w-[90%] m-auto my-10">
        ...
        <div className="grid grid-cols-1  lg:grid-cols-3 gap-5 lg:gap-10 mt-32" >
           <CustomerCard/>
            <div className="border fruits overflow-hidden text-white relative rounded-lg w-full aspect-video lg:h-[120%] self-end flex flex-col justify-around p-10 shadow-sm shadow-gray-200">
