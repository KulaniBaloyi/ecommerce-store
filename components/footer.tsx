...
const Footer = () => {
  return (
    <footer className=" border-t border-[#e5e5e5] lg:p-10 p-5  grid grid-cols-1 lg:grid-cols-4">
      <section className="lg:items-end mb-5 gap-5 p-1 lg:p-5 lg:order-last lg:col-span-1 flex flex-col">
      ...
      <section className="flex flex-wrap gap-2 justify-between lg:order-1 py-1.5 px-3 lg:col-span-3">
